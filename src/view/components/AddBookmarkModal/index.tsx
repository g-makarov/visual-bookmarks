...
import { Checkbox } from '~/view/components/form/Checkbox';
...
export const AddBookmarkModal: React.FC<Props> = ({ isOpen, close, folderId, bookmark }) => {
              ...
              <div className="flex flex-col items-center">
                <button
                  ...
                  className={clsx(styles['preview-tile'], {
                    [styles['preview-tile--selected']]: selectedLogo === 'default',
                  })}
                ...
                >
                  <div className={styles['preview-tile__logo']}>
                    ...
                    {!defaultLogo && (
                      <div className={styles['preview-tile__logo-title']}>{name[0]}</div>
                    )}
                  </div>
                </button>
              ...
              {customLogo && (
                <div className="flex flex-col items-center">
                  <button
                    type="button"
                    className={clsx(styles['preview-tile'], {
                      [styles['preview-tile--selected']]: selectedLogo === 'custom',
                    })}
